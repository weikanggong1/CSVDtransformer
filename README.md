...
## Usage
1. Download the example data and model checkpoints from this [link](https://github.com/weikanggong1/CSVDtransformer). Unzip it in the same directory as the apply_model.py script.
